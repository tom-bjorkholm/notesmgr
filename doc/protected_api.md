...
* [notesmgr.dialogs](#notesmgr.dialogs)
  ...
  * [ChoiceDialog](#notesmgr.dialogs.ChoiceDialog)
    ...
    * [\_fill\_with\_options](#notesmgr.dialogs.ChoiceDialog._fill_with_options)
...
<a id="notesmgr.dialogs.ChoiceDialog._fill_with_options"></a>

#### \_fill\_with\_options

```python
def _fill_with_options(question: str, options: Sequence[str]) -> None
```

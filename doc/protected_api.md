...
* [notesmgr.main\_window](#notesmgr.main_window)
  ...
  * [MainWindow](#notesmgr.main_window.MainWindow)
    ...
    * [\_edit\_key](#notesmgr.main_window.MainWindow._edit_key)
...
```python
def _note_entries(keys: Shortcuts) -> list[MenuEntry]
```
...
```python
def _folder_entries(keys: Shortcuts) -> list[MenuEntry]
```
...
<a id="notesmgr.main_window.MainWindow._edit_key"></a>

#### \_edit\_key

```python
def _edit_key(_event: 'tkinter.Event[ttk.Treeview]') -> None
```
...
```python
def _close_table(table: TableReader) -> None
```

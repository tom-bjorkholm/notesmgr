...
* [notesmgr.main\_window](#notesmgr.main_window)
  ...
  * [MainWindow](#notesmgr.main_window.MainWindow)
    ...
    * [\_add\_file\_menu](#notesmgr.main_window.MainWindow._add_file_menu)
...
<a id="notesmgr.main_window.MainWindow._add_file_menu"></a>

#### \_add\_file\_menu

```python
def _add_file_menu() -> tkinter.Menu
```
